...
// #Modifiers: static
// #Author(s): Conan Reis
AObjReusePool<ADatum> & ADatum::get_pool()
  {
  static AObjReusePool<ADatum> s_pool(Agog::get_agog_core_vals().m_pool_init_datum, Agog::get_agog_core_vals().m_pool_incr_datum);
  //A_DSINGLETON_GUARD;
