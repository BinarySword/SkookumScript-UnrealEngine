...
// like SSCompiler - uses ASymbolTable.
//
...
//---------------------------------------------------------------------------------------
// Constant Symbol Helper Macros - see SSSymbol.hpp for usage examples for these defines.
...
class ASymbol
  ...
  // Creation Methods
    ...
    // via macros (see SSSymbol for examples) - should be used instead.
