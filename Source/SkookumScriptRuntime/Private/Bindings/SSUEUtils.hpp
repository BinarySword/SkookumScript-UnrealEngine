...
#ifndef __SSUEUTILS_HPP
#define __SSUEUTILS_HPP
...
//---------------------------------------------------------------------------------------
// Storage specialization - TWeakComponentPtr<UParticleSystemComponent> stored indirectly as pointer in SSUserData rather than whole structure
template<> inline TWeakComponentPtr<UParticleSystemComponent> * SSUserDataBase::as<TWeakComponentPtr<UParticleSystemComponent>>() const { return as_stored<TWeakComponentPtr<UParticleSystemComponent>>(); }

//---------------------------------------------------------------------------------------
// Helper class for delegate callbacks
// $Revisit - Should look at this again in the future
class SSUERawICoroutineResume : public SSInvokedCoroutine
  {
  public:
