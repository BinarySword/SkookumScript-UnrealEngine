...
#ifndef __SSUEREMOTE_HPP
#define __SSUEREMOTE_HPP
...
class SSUERemote : public SkookumRemoteRuntimeBase
  {
  public:
  ...
  // Common Methods
    ...
    virtual void              set_mode(eSSLocale mode) override;
