...
class SKOOKUMSCRIPTRUNTIME_API USkookumScriptListener : public UObject
  ...
  // Methods
    ...
    void                initialize(UObject * obj_p, SSInvokedCoroutine * coro_p, tUnregisterCallback callback_p);
    void                deinitialize();
  ...
  // Internal Data Members
    ...
    AIdPtr<SSInvokedCoroutine>  m_coro_p;                // The coroutine that is suspended waiting for events from this object
...
template<> inline FSkookumScriptListenerAutoPtr * SSUserDataBase::as<FSkookumScriptListenerAutoPtr>() const { return as_stored<FSkookumScriptListenerAutoPtr>(); }
