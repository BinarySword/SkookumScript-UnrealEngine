...
//=======================================================================================
// SSTypeContext Inline Methods
//=======================================================================================

//---------------------------------------------------------------------------------------
// Default Constructor
// # Author(s): Conan Reis
A_INLINE SSTypeContext::SSTypeContext() :
...
// # See:      free_all_locals(), empty_locals()
// # Author(s): Conan Reis
A_INLINE void SSTypeContext::free_all_locals()
  {
  m_top_scope.empty();
  m_scope_stack.remove(&m_top_scope);
  m_scope_stack.free_all();
...
// # Author(s): Conan Reis
A_INLINE bool SSTypeContext::is_locals() const
  {
...
// # Author(s): Conan Reis
A_INLINE void SSTypeContext::nest_locals()
  {
  // $Revisit - CReis [Memory] These structures should come from a memory pool
  ScopeVars * vars_p = SS_NEW(ScopeVars);
...
// # Author(s): Conan Reis
A_INLINE void SSTypeContext::unnest_locals(
