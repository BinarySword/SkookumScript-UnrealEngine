...
// # Author(s):  Conan Reis
A_INLINE SSCoroutineCall::SSCoroutineCall(
  const ASymbol & coroutine_name, // = ASymbol::ms_null,
  SSClass *       scope_p        // = nullptr
  ) :
  SSInvokeBase(coroutine_name, scope_p)
  {
  }
...
//             SSInvokeBase derived object needs to be promoted to a dynamic heap
//             allocated object.
// # Author(s): Conan Reis
A_INLINE SSCoroutineCall::SSCoroutineCall(SSInvokeBase * call_p) :
  SSInvokeBase(call_p)
  {
  }
...
// # Author(s): Conan Reis
A_INLINE SSCoroutineCall::SSCoroutineCall(const void ** binary_pp)
  {
