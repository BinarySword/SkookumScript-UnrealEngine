...
// # Author(s): Conan Reis
A_INLINE bool SSMemberInfo::operator==(const SSMemberInfo & info) const
  {
  return ((m_type == info.m_type)
    && ((m_type == SSMember__invalid)
      || ((m_class_scope == info.m_class_scope) && (m_member_id == info.m_member_id)))); 
  }
