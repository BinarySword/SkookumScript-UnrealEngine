...
// # Author(s): Conan Reis
A_INLINE SSParser::Args::Args() :
  m_flags(ArgFlag__default),
  m_start_pos(0u),
  m_end_pos(0u),
  m_result(SSParser::Result_ok),
  m_type_p(nullptr),
...
// # See:      other constructors, reset() methods
// # Author(s): Conan Reis
A_INLINE SSParser::Args::Args(const Args & args) :
...
// # See:      other constructors, reset() methods
// # Author(s): Conan Reis
A_INLINE SSParser::Args & SSParser::Args::operator=(const Args & args)
  {
  m_flags          = args.m_flags;
  m_start_pos      = args.m_start_pos;
  m_end_pos        = args.m_end_pos;
...
// # See:      other constructors, reset() methods
// # Author(s): Conan Reis
A_INLINE SSParser::Args & SSParser::Args::reset()
  {
  m_start_pos      = 0u;
  m_flags          = ArgFlag__default;
  m_type_p         = nullptr;
...
// # See:      other constructors, reset() methods
// # Author(s): Conan Reis
A_INLINE SSParser::Args & SSParser::Args::reset(uint32_t start_pos)
  {
  m_start_pos      = start_pos;
  m_flags          = ArgFlag__default;
  m_type_p         = nullptr;
...
// # Author(s): Conan Reis
A_INLINE SSParser::SSParser(const AString & str) :
  AString(str),
  m_flags(ms_default_flags),
  m_member_type(SSMember__invalid)
  {
  reset_scope();
  }
...
// # Author(s): Conan Reis
A_INLINE bool SSParser::is_constructor(
