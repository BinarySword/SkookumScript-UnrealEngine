...
class SkookumRemoteRuntimeBase : public SkookumRemoteBase 
  ...
  // Commands
    ...
    bool cmd_recompile_classes(SSClass * class_p, bool recurse, bool wait_reply = true);
    void cmd_breakpoint_hit(const SSBreakPoint & bp);
    void cmd_break_expression(const SSMemberExpression & expr_info);
  ...
  // Events
    ...
    void         on_cmd_breakpoint_update(SSBreakPoint * bp_p, SSBreakPoint::eUpdate action);
    void         on_cmd_break_continue();
    void         on_cmd_break_step(SSDebug::eStep step_type);
    ...
    virtual void on_breakpoint_hit(const SSBreakPoint & bp);
    virtual void on_break_expression(const SSMemberExpression & expr_info);
